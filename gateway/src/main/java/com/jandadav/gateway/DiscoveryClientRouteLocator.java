...
/**
 * Shameless copy of DiscoveryClientRouteDefinitionLocator
 *
 * For science
 *
 */
@Slf4j
public class DiscoveryClientRouteLocator<properties> implements RouteDefinitionLocator {
    ...
    public DiscoveryClientRouteLocator(ReactiveDiscoveryClient discoveryClient,
    ...
    private DiscoveryClientRouteLocator(String discoveryClientName, DiscoveryLocatorProperties properties) {
